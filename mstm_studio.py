...
class MSTM_studio:
    ...
    def _create_menu(self, top):
        ...
        self.matmenu.add_command(label="Add const...", command=sup.btAddMatClick)
        self.matmenu.add_command(label="Load funct...", command=sup.btLoadMatClick)
        #~ self.matrepmenu = Menu(self.matmenu, tearoff=0)
        #~ self.matrepmenu.add_command(label="Add const...", command=sup.btAddMatClick)
        #~ self.matrepmenu.add_command(label="Load funct...", command=sup.btLoadMatClick)
        #~ self.matmenu.add_cascade(label='Replace', menu=self.matrepmenu)
